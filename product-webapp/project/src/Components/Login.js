    ...
    useEffect(() => {
        if (Object.keys(formErrors).length === 0 && isSubmit ) {
            ...
            if (formValues.role === "players") {
                ...
                axios
                    .get("http://44.208.58.122:3000/players/2")
                    .then((response) => {
                ...
                axios
                .get("http://44.208.58.122:3000/vendors/1")
                .then((response) => {
                    // console.log(response.data);
                   let values= response.data;
    ...
    const handleSubmit = (e) => {
        ...
        postData(formValues, (res) => {
            ...
            if(formValues.role==="newground"){
                axios.get(`http://44.208.58.122:8080/user/api/v1/ground/ownerEmail/`+formValues.userEmail)
                .then((res)=>{
